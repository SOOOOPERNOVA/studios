...
(function () {
  ...
  var OBJ = [
    ['o7', -3,  -5, 290, 250,  -8,  3, 13,  0, false], // 핑크 물결
    ['o2', 63, 11, 240,  0,  10,  8, 14, .3, true ], // 라벤더 별
    ['o0', 90,  6, 240,  0,  -8,  4, 13, .9, false], // 노란 모래시계
    ['o5', 46, 50, 360,  0,  -9,  3, 12, .7, true ], // 노란 구슬기둥
    ['o1', 18, 66, 200, -8,  -9,  5, 12, .4, true ], // 빨강
    ['o4', -5, 82, 210,  0,  10, -4, 14, .4, false], // 하늘 블롭
    ['o8', 60, 62, 560,  0,  -8,  3, 13, .6, false]  // 초록 아치
  ];
